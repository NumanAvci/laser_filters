...
#include <string>
#include <limits>
#include "simple_layers/filter_base.h"
#include <sensor_msgs/LaserScan.h>
#include <limits>
...
class PlatformFilter : public filters::FilterBase<sensor_msgs::LaserScan>
{
	...
	private:
		...
		bool isIntersection(float angle, double scan_data__range_index, double robot_yaw);
		bool isOnPlatform();
		...
		double laser_x_, laser_y_, laser_z_;//coordinate of laser according to map
